...
//    vector <char> vowels; // 5 initialised to  zero
...
//     vector <int> test_scores (3, 100);
    ...
    cout << "\nTest scores are " << test_scores.size() << " scores in the vector" << endl;
...
//    Example of a 2D-vector
    ...
    cout << "nHere are the movie rating for reviewer #1 using vector syntax:" << endl;
