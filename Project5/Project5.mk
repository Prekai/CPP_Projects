...
ProjectPath            :=C:/Users/arnot/Desktop/CppProject/NewCPPproject/Cpp_project_again/Project5
...
$(OutputFile): ../build-$(ConfigurationName)/Project5/.d $(Objects) 
	@if not exist "..\build-$(ConfigurationName)\Project5" mkdir "..\build-$(ConfigurationName)\Project5"
...
../build-$(ConfigurationName)/Project5/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Project5/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/arnot/Desktop/CppProject/NewCPPproject/Cpp_project_again/Project5/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
