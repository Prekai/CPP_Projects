...
ProjectPath            :=C:/Users/arnot/Desktop/CppProject/NewCPPproject/Cpp_project_again/Project6
...
Objects0=../build-$(ConfigurationName)/Project6/main.cpp$(ObjectSuffix) 
...
$(OutputFile): ../build-$(ConfigurationName)/Project6/.d $(Objects) 
	@if not exist "..\build-$(ConfigurationName)\Project6" mkdir "..\build-$(ConfigurationName)\Project6"
...
../build-$(ConfigurationName)/Project6/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Project6/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/arnot/Desktop/CppProject/NewCPPproject/Cpp_project_again/Project6/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
